...
from utils import is_admin, is_super_admin, get_bot_username, invalidate_channel_cache, invalidate_admin_cache
...
async def approve_vip_payment(message: Message, bot: Bot):
    ...
    # VIP qo'shish
    from handlers.user_handlers import add_vip_to_user
...
async def _show_animes_list(message: Message):
    async with aiosqlite.connect(DB_PATH) as db:
